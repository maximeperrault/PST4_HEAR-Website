...
<html>
<?php $resultat = exec('python map_site.py'); //on execute le script python
?>
	<head>
    ...
    <div class="container" id="dashboard">
      <div class="col-md-2 col-sm-2">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li role="presentation" class="active"><a href="dashboard_map.php">Map</a></li>
        </ul>
      </div>
      <div id="map" alt="" class="logo" style="width: 800px; height: 470px;">
	  <p><?php echo $resultat; //on affiche la carte?><p></div>
    </div>
